            ...
            vessel -> {
              ImportantVesselDTO importantVessel =
                  ImportantVesselDTO.builder()
                      ...
                      .type(vessel.getType())
                      .flag(vessel.getFlag())
                      .built(vessel.getBuilt())
                      .gear(vessel.getGear())
                      .grain(vessel.getGrain())
                      .manager(vessel.getManager())
                      .pic(vessel.getPic())
                      .speed(vessel.getSpeed())
                      .ifo_ballast(vessel.getIfo_ballast())
                      .ifo_laden(vessel.getIfo_laden())
                      .port_idle(vessel.getPort_idle())
                      .port_working(vessel.getPort_working())
                      .mgo_port_idle(vessel.getMgo_port_idle())
                      .mgo_port_working(vessel.getMgo_port_working())
                      .boiler(vessel.getBoiler())
                      .important(user.getImportantVessels().contains(vessel))
                      .build();
